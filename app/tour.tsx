          ...
          <div className="source-scroll">
            ...
            <div className="dimension-table">
              ...
              <div>
                <b>全景漫游</b>
                <p>
                  18 个空间、24 个观察点，基于现有现代简约布局与已确认样图，用 AI 生成写实全景，统一午后自然光与室内暖光。
                  可环顾、缩放和切换点位，图片已通过 TinyPNG 压缩并配有手机预览。全景中的家具和光线固定，局部细节可能与模型有差异；需要自由行走或查看模型空间关系时，请切换“进入漫游”。全景为装修效果示意，并非实拍照片。
                </p>
              </div>
            </div>
          </div>
