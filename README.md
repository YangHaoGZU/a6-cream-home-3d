...
- 电梯厅与入户门连通，补充开放的电梯轿厢、门套、按钮及 20 层层显、双跑步梯和平台、公共走廊与三组设备井门。走廊东端封墙，电梯厅一侧的大门南边增设鞋柜。
...
[下载现代简约 V3 模型](models/A6-modern-minimalist-v3.blend?raw=true) · [实物家具来源与多视角预览说明](models/README.md)。本版已关闭入户大门，使用宜家实物尺寸参考重建家具，贴图已打包。此模型独立于当前网页版本；本次仅上传模型，未渲染或替换全景图。
